    ...
    <div className='coin-info-detail-info'>
      <div className="coin-info-detail-info__head-info">
        <div className="item">
          ...
          <div className="text">{formatCost(toFixedString(coinInfo.mktcap, 0), coinInfo.toSymbol, coinInfo.toCode)}</div>
        </div>

        <div className="item">
          <div className="title">24H Volume</div>
          <div className="text">{formatCost(toFixedString(coinInfo.directVol, 0), coinInfo.toSymbol, coinInfo.toCode)}</div>
        </div>

        <div className="item">
          <div className="title">Low/High 24h</div>
          <div className="text">{formatCost(`${toFixedString(coinInfo.low24Hour, 3)} / ${toFixedString(coinInfo.high24Hour, 3)}`, coinInfo.toSymbol, coinInfo.toCode)}</div>
        </div>
