...
const CoinInfo: React.FC<TProps> = ({ targetCoinCode, setTargetCoinCode }) => {
  ...
  return (
    <Header targetCoinCode={targetCoinCode} onTargetCoinChange={onTargetCoinCodeChanged} />
  )
}
...
export default connect<TMapState, TMapDispatch, {}, TRootState>(mapState, { setTargetCoinCode })(CoinInfo)
